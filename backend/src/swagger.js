import { PetSize, PetStatus } from '@prisma/client';
...
definitions: {
  Pet: {
    ...
    required: ["name", "specie", "breed", "gender", "dob", "description", "size", "personality"]
  }
}
};
...
const routes = ["./routes/userRoutes.js", "./routes/petsRoutes.js", "./routes/adoptRoutes.js"];
